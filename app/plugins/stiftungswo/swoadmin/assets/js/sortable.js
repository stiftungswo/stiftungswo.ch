...
function initializeSorting() {
	...
	$('.list-widget tbody').sortable().unbind('sortupdate');
	$('.list-widget tbody').sortable().bind('sortupdate', function(e) {
		...
		// console.log(e);
		// console.log($('.index_reposition').map(function(){  return $(this).val() }).get())

		$.request('onUpdateProjectPosition', {
			data: {
				checked: $('.index_reposition').map(function(){  return $(this).val() }).get()
			},
